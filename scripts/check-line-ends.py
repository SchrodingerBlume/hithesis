...
（mutool stext 逐字符抽取，按段落锚定）。本脚本把 demo 的 thesis.pdf 用同一套
...
用法：check-line-ends.py [--pdf examples/demo/thesis.pdf] [--fixture tests/lineends-regu.tsv]
...
def main():
    ...
    ap.add_argument('--pdf', default='examples/demo/thesis.pdf')
